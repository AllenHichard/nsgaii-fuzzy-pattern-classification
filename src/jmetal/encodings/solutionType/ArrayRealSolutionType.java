...
public class ArrayRealSolutionType extends SolutionType {
    ...
    public ArrayRealSolutionType(Problem problem, int tamanhoInt, double[] semente) {
        super(problem);
        this.tamanhoInt = tamanhoInt;
    ...
    public Variable[] createVariables() {    
        ...
        variables[0] = new ArrayReal(tamanhoInt, problem_, semente);
        return variables;
    } // createVariables
