...
public class TESTE3 {
    ...
    public TESTE3(String fold, String nomeArquivo, String test, double[] Acuracia, double[] Interpretabilidade, int posicao) throws IOException {
    ...
    private void Carregarregras(String fold, int i) throws FileNotFoundException, IOException {
        ...
        BufferedReader ler = new BufferedReader(new FileReader("saida\\" + fold + "\\" + "TREINAMENTO" + "\\" + fold+"-"+(i + 1)+ " - Regras.txt"));
    ...
    private void iniciaInferencia(String fold, int i) {
        try {
            BufferedReader ler = new BufferedReader(new FileReader("saida\\" + fold + "\\" + "TREINAMENTO" + "\\" + fold+"-"+(i + 1)+ ".FLC"));
    ...
    public double testSimulado(double[] Acuracia, double[] Interpretabilidade, int posicao) {
        ...
        for (int i = 0; i < TestEntrada.size(); i++) {
            ...
            //System.out.println(TestEntrada.get(i).toString().length() + "-" + ConversaoValor.nomeValor(TestSimulado.get(i).toString()).length());
    ...
    public static void main(String[] args) throws IOException {
        ...
        for (int i = 0; i < Acuracia.length; i++) {
            ...
            new TESTE3(fold, nomeArq[i], nomeArqTest[i], Acuracia, Interpretabilidade, i);
        }
    ...
    public static void desvioPadrão(String fold, double[] acuracias, double[] interpretabilidades, String nome, long estimatedTime) throws IOException {
       ...
       // File diretorio = new File("saida\\" + fold + "\\" + "TESTE" + T);
        //diretorio.mkdir();
        BufferedWriter gravar = new BufferedWriter(new FileWriter("saida\\" + fold + "\\Teste AG Resultados.txt"));
        for (int i = 0; i < acuracias.length; i++) {
             gravar.write("Arquivo " + (i + 1) + " - Acurácia = " + acuracias[i] + " +/- " + dpA + "\r\n");
