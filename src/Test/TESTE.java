...
public class TESTE {
    ...
    public TESTE(String fold, String nomeArquivo, String test, double[] Acuracia, double[] Interpretabilidade, int posicao) throws IOException {
    ...
    public static void main(String[] args) throws IOException {
        ...
        for (int i = 0; i < Acuracia.length; i++) {
            ...
            new TESTE(fold, nomeArq[i], nomeArqTest[i], Acuracia, Interpretabilidade, i);
        }
